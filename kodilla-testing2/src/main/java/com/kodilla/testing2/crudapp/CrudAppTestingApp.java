...
public class CrudAppTestingApp {
    ...
    public static final String XPATH_TESTAREA = "//html/body/main/section/form/fieldset[2]/textarea";
    ...
    public static void main(String[] args) {
        ...
        driver.get("https://hbartek230.github.io");

        WebElement searchElement = driver.findElement(By.xpath(XPATH_INPUT));
        searchElement.sendKeys("New robotic task");

        WebElement textElement = driver.findElement(By.xpath(XPATH_TESTAREA));
        textElement.sendKeys("New robotic content");

        while (!driver.findElement(By.xpath(XPATH_WAIT_FOR)).isDisplayed());

        WebElement selectElement = driver.findElement(By.xpath(XPATH_SELECT));
        Select selectBoard = new Select(selectElement);
