...
import com.kodilla.good.patterns.food2door.deliversrepositories.ExtraFoodShopRepository;
...
public class ExtraFoodShop implements DeliversService {

    public ExtraFoodShop(ServiceRepositoryConnector connector){
